...
def generate_plot(data, kernel_name):
    ...
    plt.bar(bar_positions, xve_utilization['XVE Array:Active(%)'], color='tab:blue')
    plt.bar(bar_positions, xve_utilization['XVE Array:Idle(%)'], color='tab:orange', bottom=xve_utilization['XVE Array:Active(%)'])
    plt.bar(bar_positions, xve_utilization['XVE Array:Stalled(%)'], color='tab:grey', bottom=xve_utilization['XVE Array:Active(%)'] + xve_utilization['XVE Array:Idle(%)'])
